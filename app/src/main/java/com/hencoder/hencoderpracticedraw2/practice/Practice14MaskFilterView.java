...
public class Practice14MaskFilterView extends View {
    ...
    BlurMaskFilter blurMaskFilter1 = new BlurMaskFilter(50, BlurMaskFilter.Blur.INNER);
    BlurMaskFilter blurMaskFilter2 = new BlurMaskFilter(50, BlurMaskFilter.Blur.OUTER);
    BlurMaskFilter blurMaskFilter3 = new BlurMaskFilter(50, BlurMaskFilter.Blur.SOLID);
